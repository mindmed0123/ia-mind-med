...
const Email = ({ firstName, daysRemaining = 7 }: Props) => {
  ...
  return (
    <Html lang="pt-BR" dir="ltr">
      <Head />
      <Preview>A metade do seu trial passou. O que acontece nos próximos dias define tudo.</Preview>
      <Body style={s.main}>
        <Container style={s.container}>
          ...
          <Section style={s.content}>
            <Heading style={s.h1}>Metade do seu teste, {greet} — veja o que você já tem</Heading>
            <Text style={s.text}>Você está na metade do seu teste de 7 dias.</Text>
            ...
            <Text style={s.text}>Nos dias que restam, você ainda tem tempo de:</Text>
            <ol style={s.list}>
            ...
            <Section style={s.ctaSection}>
              <Button style={s.ctaButton} href={`${APP_URL}`}>Continuar usando a MindMed →</Button>
            </Section>
            ...
            <Text style={s.small}>Seu teste de 7 dias encerra em {daysRemaining} dias. Seu cartão já está cadastrado e a primeira cobrança só acontece no fim do teste.</Text>
          </Section>
        </Container>
      </Body>
    </Html>
...
export const template = {
  component: Email,
  subject: (d: Record<string, any>) => `Metade do seu teste, Dr(a). ${d.firstName || 'Doutor(a)'} — veja o que você já tem`,
