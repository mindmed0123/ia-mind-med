...
export const InviteEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Você foi convidado(a) para o MindMed</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          ...
          <Section style={benefitsBox}>
            <Text style={benefitItem}>🧠 Laudos médicos com IA avançada</Text>
            <Text style={benefitItem}>📋 Prescrições automáticas inteligentes</Text>
            <Text style={benefitItem}>⚡ Transcrição de áudio inteligente</Text>
            <Text style={benefitItem}>✨ MindChat — assistente médico com IA</Text>
          </Section>
...
const benefitsBox = { backgroundColor: '#f0f7ff', borderRadius: '10px', padding: '20px 24px', margin: '24px 0', borderLeft: '4px solid hsl(220, 85%, 38%)' }
